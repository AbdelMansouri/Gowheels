...
class Commande
{
    ...
    #[Assert\GreaterThanOrEqual(value: "today", message: "Veuillez sélectionner des dates antérieur à la date d'aujourd'hui")]
    #[Assert\LessThanOrEqual(propertyPath: "date_heure_fin", message: "Le début de la location doit se faire avant sa fin")]
    #[ORM\Column(type: Types::DATETIME_MUTABLE)]
    private ?\DateTimeInterface $date_heure_depart = null;

    #[Assert\GreaterThanOrEqual(value: "today", message: "Veuillez sélectionner des dates antérieur à la date d'aujourd'hui")]
    #[Assert\GreaterThanOrEqual(propertyPath: "date_heure_depart", message: "La fin de la location doit se faire avant son début")]
    #[ORM\Column(type: Types::DATETIME_MUTABLE)]
